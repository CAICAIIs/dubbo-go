...
func SetServingStatusServing(service string) {
	_ = healthServer.SetServingStatus(service, triple_health.HealthCheckResponse_SERVING)
}

func SetServingStatusNotServing(service string) {
	_ = healthServer.SetServingStatus(service, triple_health.HealthCheckResponse_NOT_SERVING)
}
